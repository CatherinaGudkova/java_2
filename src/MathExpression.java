...
public class MathExpression {
    ...
    public static String sort_position(String expression, Map<String, Integer> operations, String leftBracket, String rightBracket)
    {
    ...
    public static String sort_position(String expression, Map<String, Integer> operations) {
        return sort_position(expression, operations, "(", ")");
    }

    public static BigDecimal calculateExpression(String expression) {
        String sp = sort_position(expression, MAIN_MATH_OPERATIONS);
